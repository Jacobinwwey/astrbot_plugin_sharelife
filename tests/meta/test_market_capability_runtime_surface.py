...
def test_market_pages_load_shared_capability_runtime_helpers_before_market_page() -> None:
    for page_name in ("market.html", "market_detail.html"):
        ...
        policy_runtime_pos = text.find('/capability_policy_runtime.js')
        ...
        assert policy_runtime_pos >= 0, f"{page_name} missing capability_policy_runtime.js"
        ...
        assert policy_runtime_pos < market_page_pos, f"{page_name} loads market_page.js before capability policy runtime"

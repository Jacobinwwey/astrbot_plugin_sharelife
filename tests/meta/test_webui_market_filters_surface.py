...
def test_market_filters_script_is_wired_before_market_page_script() -> None:
    ...
    assert '<script src="/market_catalog_insights.js"></script>' in market_html
    assert '<script src="/market_catalog_view.js"></script>' in market_html
    assert '<script src="/market_compare_helpers.js"></script>' in market_html
    ...
    assert market_html.index('<script src="/market_auth_view.js"></script>') < market_html.index(
        '<script src="/market_catalog_insights.js"></script>'
    )
    assert market_html.index('<script src="/market_catalog_insights.js"></script>') < market_html.index(
        '<script src="/market_catalog_view.js"></script>'
    )
    assert market_html.index('<script src="/market_catalog_view.js"></script>') < market_html.index(
        '<script src="/market_compare_helpers.js"></script>'
    )
    assert market_html.index('<script src="/market_compare_helpers.js"></script>') < market_html.index(
